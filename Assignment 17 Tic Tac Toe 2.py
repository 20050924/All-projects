...
#Programming 11
#2021/10/5
#Assignment 17, A tic tac toe game program that player aginst Ai, Ai can't find out it can win
from tkinter import *
import random
root = Tk()
...
def O(event):
    ...
    if event.x <= 222 and event.y <= 222 and gamestate[0] == "" :
        ...
        X()
    print(gamestate)
#player clicked mouse and create a O on what ever square they click. Also prints gamestate.
def createX1():
...
def X():
    ...
    while True:
        ...
        print(random_int)
        #represents a random spot Ai going to put(if player is going to win won't follow the spot)
